...
const AidenUpgrades = {
    list: () => requests.get<AidenUpgrade[]>('/aidenupgrade'),
    create: (au: AidenUpgrade) => axios.post('/aidenupgrade', au),
    update: (au: AidenUpgrade) => axios.put(`/aidenupgrade/${au.id}`, au),
    delete: (id: string) => axios.delete(`/aidenupgrade/${id}`),
}
